...
Player::Player(sf::Texture* texture, float windowWidth, float windowHeight) : AnimatedEntity(texture) {
    //TODO: if window is resized, we will need to update the player's position. the player is always in the middle of the screen, scale of texture needs to be considered here?
