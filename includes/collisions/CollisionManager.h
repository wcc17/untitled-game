...
public:
    ...
    void checkAllCollisions(const std::shared_ptr<PlayerEntity>& player,
...
private:
    ...
    void checkCollisionsWithPlayerAndMap(const std::shared_ptr<PlayerEntity>& player);
    void checkCollisionsWithPlayerAndEntities(const std::shared_ptr<PlayerEntity>& player, const std::vector<std::shared_ptr<NpcEntity>>& entities);
    ...
    void handleCollisionWithPlayerAndNpcEntity(const std::shared_ptr<PlayerEntity>& player, std::shared_ptr<NpcEntity> npc);
    void handleCollisionWithNpcAndNpc(const std::shared_ptr<NpcEntity> npc1, const std::shared_ptr<NpcEntity> npc2);
    void handleCollisionWithPlayerAndDoor(const std::shared_ptr<PlayerEntity>& player, const Collidable& collidable);
    void handleCollisionWithPlayerAndMap(const std::shared_ptr<PlayerEntity>& player, const std::shared_ptr<Collidable> collidable);
